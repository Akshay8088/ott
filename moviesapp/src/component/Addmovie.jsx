...
const Addmovie = () => {
   ...
   // let moviename = useRef();
    ...
    let handleAddNewMovie = (e)=>{
        ...
        fetch(" http://localhost:4004/movies" , 
                                                {
                                                    method : "POST",
    ...
    return ( 
        <div className="add-movie">
            ...
            <form onSubmit={ handleAddNewMovie }>
                ...
                <input type="text" ref={heroine} />
                <input type="text" ref={director}/>
                <fieldset>
                ...
                <input type="url" ref={poster} />
                <input type="url" ref={trailer}/>
                <input type="number" min="1950" max="2024" ref={release} />
                <input type="number" min="1" max="10" step="0.1" ref={rating} />
